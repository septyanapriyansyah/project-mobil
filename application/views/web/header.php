        ...
        <div class="col-md-8">
          <div class="spara">
            ...
            <p>
                                  ...
                                  <td><a href="jualmobil" class="btn btn-info" role="button">Jual Mobil</a></td>

                                  <i class="fa fa-envelope-o lightblue"></i> <?php echo $data_web->email; ?> &nbsp;
              <i class="fa fa-phone lightblue"></i> <?php echo $data_web->telp; ?>
              <i class="fa fa-instagram lightblue">  Penjualan Mobil</i> 
            </p>
          </div>
        </div>
        <div class="col-md-4">
          ...
          <div class="logo">
            ...
            <div class="logo-image">
              ...
              <a href="<?php echo base_url(); ?>">
								<img src="img/logo1.jpeg" alt="Logo <?php echo $data_web->nama_web; ?>" style="margin-top:10px;max-height:80px;">
							</a>
            </div>
          ...
          <div class="navi pull-right">
            <div id="ddtopmenubar" class="mattblackmenu">
              ...
              <ul>
                ...
                <li>
									<a href="jualmobil" class="bred"> <i class="fa fa-home"></i> Home</a>
								</li>

                <li>
									<a href="about" class="borange"> <i class="fa fa-user-md"></i> About</a>
                </li>

								<li>
									<a href="artikel" class="bgreen"> <i class="fa fa-globe"></i> Artikel</a>
                </li>

                <li>
									<a href="help" class="bblue"> <i class="fa fa-question-circle"></i> Help</a>
								</li>
                ...
                <!-- <li>
								...
								<li>
									<?php
									if ($ceks) {?>
										<a href="member" class="bblack"> <i class="fa fa-user"></i> Member</a>
									<?php
									}else{ ?>
										<a href="login" class="bblack"> <i class="fa fa-key"></i> Login</a>
									<?php
									} ?>
								</li>
